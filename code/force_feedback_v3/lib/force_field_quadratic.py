...
_COEF_DN = np.array([-0.477186, -0.054439, -0.052543, 0.000651, -0.002317, 0.004243])
_COEF_DB = np.array([-0.355445, -0.050930, 0.360596, -0.000812, 0.010073, 0.004712])
...
def inverse(Fn_meas, Fo_meas):
    ...
    Returns:
        (dn, db): 偏移量 (mm)，相对参考轨迹。(-8,0)→(0,0) 硬锚定。
